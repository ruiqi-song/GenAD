...
model = dict(
    ...
    # pretrained=dict(img='/file_system/vepfs/algorithm/ruiqi.song/.cache/torch/hub/checkpoints/resnet50-0676ba61.pth'),
    pretrained=dict(img='/file_system/vepfs/algorithm/ruiqi.song/helios/models/VAD/ckpts/resnet50-19c8e357.pth'),
    img_backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
    ...
    pts_bbox_head=dict(
        ...
        loss_vlm_align=dict(type='VLAlignLoss', loss_weight=1.0)),
        # loss_vlm_itc=dict(type='VLAlignLoss', loss_weight=1.0),
        # loss_vlm_lm=dict(type='VLAlignLoss', loss_weight=1.0)),
        # loss_vlm_itm=dict(type='VLAlignLoss', loss_weight=1.0)),
...
data_root = '/file_system/vepfs/algorithm/ruiqi.song/helios/models/e2e/GenAD/datas/'
# data_root = '/file_system/vepfs/algorithm/ruiqi.song/helios/data/data_nusc/'
data_root_origin = '/file_system/vepfs/public_data/nuScenes/'
# data_root_ = '/mnt/nas/algorithm/ruiqi.song/helios/models/genAD/VAD/'
# data_root = '/remote-home/share/public_data/nuScenes/nuscenes/'
...
data = dict(
    ...
    val=dict(type=dataset_type,
             ...
             map_classes=map_classes,
             map_ann_file=data_root_origin + 'nuscenes_map_anns_val.json',
             map_fixed_ptsnum_per_line=map_fixed_ptsnum_per_gt_line,
             map_eval_use_same_gt_sample_num_flag=map_eval_use_same_gt_sample_num_flag,
             use_pkl_result=True,
             custom_eval_version='vad_nusc_detection_cvpr_2019'),
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={
            ...
            # 'pts_bbox_head.blip': dict(lr_mult=0.1),
        }),
    weight_decay=0.01)
